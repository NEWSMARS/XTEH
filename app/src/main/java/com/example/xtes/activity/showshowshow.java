...
import java.sql.Statement;
    ...
    public class showshowshow extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.showshowshow_activity);

            search2=findViewById(R.id.search0);
            search3=findViewById(R.id.search1);
            ...
            a1=findViewById(R.id.z11);
            a2=findViewById(R.id.z22);
            a3=findViewById(R.id.z33);
            a4=findViewById(R.id.z44);
            a5=findViewById(R.id.z5);
            a6=findViewById(R.id.z6);

            s1=findViewById(R.id.x1);
            s2=findViewById(R.id.x2);
            s3=findViewById(R.id.x3);
            s4=findViewById(R.id.x4);
            s5=findViewById(R.id.x5);
            s6=findViewById(R.id.x6);

            d1=findViewById(R.id.c1);
            d2=findViewById(R.id.c2);
            d3=findViewById(R.id.c3);
            d4=findViewById(R.id.c4);
            d5=findViewById(R.id.c5);
            d6=findViewById(R.id.c6);


            Intent intent = getIntent();
            tpyename1 = intent.getStringExtra("index");
            if(!tpyename1.equals(""))
            tpyename=Integer.parseInt(tpyename1);
            if(tpyename!=0)
            {
                t=0;
                cat=tpyename;
...
//            }
            ...
            a1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(showshowshow.this,product_show.class);
       ...
       /* int imgID=0;
        ...
        public void findproductbysearch() throws java.sql.SQLException {
            ...
            String sql = "select id,productName,productPrice from t_product where productName='" + name10 +"' order by id desc limit 0,8";        //查询表名为“user”的所有内容
