...
public class change_student extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int user_id1=(int)Integer.parseInt(user_id);
		 Student student=service.findStudentByid(user_id1);
		...
		request.getRequestDispatcher("/manage/jsp/studentadd.jsp").forward(request, response);	
	}
