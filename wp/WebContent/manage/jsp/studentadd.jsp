...
<div class="app-container">
	...
	<form  action="m_studentadd22?sid=${Student.studentId}" class="form-inline" style="margin-left: 40%;margin-top: 50px" method="post">
	...
	<div class="form-group" >请输入学生数据         
		...
		<div class="form-group majorOrEle">
			...
			<c:if test="${Student.majorOrEle==0}"> 
		...
		<c:if test="${Student.majorOrEle==1}"> 
			
			<label for="exampleInput"><input type="radio"   name="majorOrEle" class="form-control" value="0"  }>必修</label>
		<label for="exampleInput"><input type="radio" name="majorOrEle" class="form-control" value="1" checked="checked">选修</label>
