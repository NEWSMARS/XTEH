            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">点击提交</div>
                    </div>
                    <form  action="m_student_add2" class="form-inline" method="post">
       
                       <td>选择导入数据源：</td>
   <td><input id="path" type="text" name="path2" size="30" value="D://student.txt"></td>
   <button type="submit" class="btn btn-default form-control"  >选择</button>
   </form>
