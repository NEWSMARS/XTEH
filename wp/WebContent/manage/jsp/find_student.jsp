...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="manage/css/themes/flat-blue.css">
    	...
    	<link rel="stylesheet" type="text/js" href="manage/js/button.js">
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">输入信息，找到相关信息的学生</div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                             ...
                                             <c:forEach items="${Studentlist}" var="newPro"> 
                                                ...
                                                <td>${newPro.studentId}</td>
                                                        ...
                                                        <td>${newPro.password}</td>
                                           
                                                     	<td>${newPro.CLASS}</td> 
                         
                                                     	<c:if test="${newPro.majorOrEle==0}"><td>必修</td>  </c:if> 
                                                     	<c:if test="${newPro.majorOrEle==1}"><td>选修</td>   </c:if> 
                                       ...
                                       <td><a href="delect_student1?delete_id=${newPro.studentId}"  class=" iconfont icon-13 delete"></a></td>
										<td><a href="change_student1?user_id=${newPro.studentId}" class="iconfont icon-12"></a></td>
