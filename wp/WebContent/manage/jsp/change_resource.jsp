...
<div class="app-container">
	...
	<div class="form-group" >请修改资源数据         
		...
		<div class="form-group" style="display: block">
			<label for="exampleInput">所属资源</label>
			<input type="text" value="${Resource.categoryId }"  name="categoryId" class="form-control">
		</div>
		<div class="form-group" style="display: block">
			<label for="exampleInput">上传用户</label>
			<input type="text" value="${Resource.uploader}"  name="uploader" class="form-control">
		</div>
		 <div class="form-group" style="display: block">
			<label for="exampleInput">资源名称</label>
			<input type="text" value="${Resource.name}"  name="name" class="form-control">
		</div> 
		
		<div class="form-group" style="display: block">
			<label for="exampleInput">资源描述</label>
		...
		<%-- <div class="form-group" style="display: block">
			<label for="exampleInput">资源等级</label>
			<input type="text" value="${Resource.level}"  name="level" class="form-control">
		</div> --%>
		<div class="form-group">
			<label for="exampleInput">资源等级</label>
			<select  name="level" class="form-control dept" >
