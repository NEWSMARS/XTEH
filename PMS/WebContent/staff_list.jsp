...
<body>
  ...
  <ul class="pagination">
    ...
    <li><a href="stafflist?page=1">1</a></li>
    <li><a href="stafflist?page=2">2</a></li>
    <li><a href="stafflist?page=3">3</a></li>
    <li><a href="stafflist?page=4">4</a></li>
    <li><a href="stafflist?page=5">5</a></li>
    <li>
   ...
   (function ($) {
    ...
    $(document).ready(function(){
    	 	$(".delete").click(function(){
    	 		$('.delete_sure').attr('href','stafflist?delete_id='+this.id);
