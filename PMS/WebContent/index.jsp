	...
	<div class="left-body">
		<div class="logo">人事管理系统</div>
	 	<ul class="nav nav-divider" >
			<li>
				<a href="home.html" target="iframe_content"><span class="iconfont icon-19 text-left" ></span><span class="manage">主页</span></a></li>
			<li class="dropdown">
				...
				<li><a href="dept_list.html" target="iframe_content">部门列表</a></li>
				<li ><a  href="dept_add.html" target="iframe_content">增加部门</a></li>
				<li><a href="dept_detail.html" target="iframe_content">部门信息</a></li>
				</ul>
			</li>
			<li class="dropdown">
			...
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown" href="#" ><span class="iconfont icon-10 " ></span><span class="manage">企业管理</span><span class="caret " ></span></a>
				<ul class="dropdown-menu ">
				<li ><a  href="company_list.html" target="iframe_content">企业列表</a></li>
				<li><a href="company_add.html" target="iframe_content">增加企业</a></li>
				<li><a href="company_detail.html" target="iframe_content">企业信息</a></li>
				</ul>
			</li>
			<li class="dropdown">
	...
	<div class="right-body">
		<div class="top-nav" style="height: 50px;background-color:#fff;border-bottom: 2px solid #f2f2f2f2;position: relative;">
			<ul class="nav nav-pills" style="position: absolute; right: 0px;bottom: 0px">
				<li><a href="login.jsp" class="iconfont icon-4" >登陆</a></li>
				<li><a href="logon.jsp" target="iframe_content">注册</a></li>
				<li><a href="home.jsp" target="iframe_content">${user.uname}</a></li>
				<li><a href="login.jsp" class="iconfont icon-4" >退出</a></li>
			</ul>
		</div>
		<div id="content" style="width: 100%; background-color: #f2f2f2f2">
			<iframe name="iframe_content" id="iframe_content" src="home.html" ></iframe>
		</div>
	</div>
