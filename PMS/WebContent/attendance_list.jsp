...
<body>
  ...
  <ul class="pagination">
    ...
    <li><a href="attendancelist?page=1">1</a></li>
    <li><a href="attendancelist?page=2">2</a></li>
    <li><a href="attendancelist?page=3">3</a></li>
    <li><a href="attendancelist?page=4">4</a></li>
    <li><a href="attendancelist?page=5">5</a></li>
    <li>
...
<script type="text/javascript">
   ...
   (function ($) {
    ...
    $(document).ready(function(){		
		$('.delete_sure').attr('href','attendancelist?page='+page);
