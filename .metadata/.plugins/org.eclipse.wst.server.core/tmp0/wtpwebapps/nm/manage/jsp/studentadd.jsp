...
<div class="app-container">
	...
	<form  action="m_studentadd22?sid=${Student.studentId}&teacher=1" class="form-inline" style="margin-left: 40%;margin-top: 50px" method="post">
	<div class="form-group" >-         
	</div>
	<div class="form-group" >-         
	</div>
	<div class="form-group" >请输入用户数据         
	</div>
