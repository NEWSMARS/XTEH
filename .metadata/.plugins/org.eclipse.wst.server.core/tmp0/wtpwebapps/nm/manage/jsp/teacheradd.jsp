...
<div class="app-container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="panel panel-default dropdown">
                            ...
                            <div id="component-example" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        <li><a href="components/m_post">贴子查看</a>
                                        </li>
                                        <li><a href="components/m_post_set">贴吧设置</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
	...
	<form  action="m_studentadd22?sid=${Student.studentId}&teacher=2" class="form-inline" style="margin-left: 40%;margin-top: 50px" method="post">
	<div class="form-group" >-         
	</div>
	<div class="form-group" >-         
	</div>
	<div class="form-group" >请输入管理员数据         
	</div>
