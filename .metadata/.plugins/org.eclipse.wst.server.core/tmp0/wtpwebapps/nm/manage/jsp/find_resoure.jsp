                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                             ...
                                             <c:forEach items="${Resourcelist}" var="newPro"> 

														<tr>
                                              			  <td>${newPro.resourceId}</td>
                                                  
                                       <c:if test="${newPro.categoryId==1}"><td>综艺</td>  </c:if> 
                                        <c:if test="${newPro.categoryId==4}"><td>动漫</td>  </c:if> 
                                           <c:if test="${newPro.categoryId==3}"><td>电视剧</td>  </c:if> 
                                           <c:if test="${newPro.categoryId==2}"><td>电影</td>  </c:if> 
                                           <c:if test="${newPro.categoryId==5}"><td>用户上传</td>  </c:if>           	
                                               ...
                                               <td>${newPro.name}</td>
                                                	  ...
                                                	  <td>${newPro.code}</td>     
                        								 <td>${newPro.area}</td> 
                                                     	 <td>${newPro.language}</td> 
                                                     	 	<td>${newPro.publish_time}</td> 
														<td>${newPro.descn}</td> 
                                                       
                                               	
                                     
                                                 
                                       <td><a href="delect_r?delete_id=${newPro.resourceId}"  class=" iconfont icon-13 delete"></a></td>
										<td><a href="change_r?user_id=${newPro.resourceId}" class="iconfont icon-12"></a></td>
