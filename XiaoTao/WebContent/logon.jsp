...
<body >
	<div style="background-image: url(pic/login.jpg);background-size: 100% 100%;background-repeat: no-repeat; position:absolute; top: 0px;bottom: 0px;width: 100%"></div>
	
	<div style="position: relative;margin:0px auto ;top: 150px;width: 300px;height: 450px;/*border: 1px solid red;*/background-color: #ffffff40">
